...
//import java.util.*;
//
//public class DefuateLogRecordContext {
//    private static final InheritableThreadLocal<Stack<StandardEvaluationContext>> VARIABLE_MAP_STACK = new InheritableThreadLocal<>();
//    private static final InheritableThreadLocal<StandardEvaluationContext> GLOBAL_VARIABLE = new InheritableThreadLocal<>();
